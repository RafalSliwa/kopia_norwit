...
class XmlFeedInstall
{
    ...
    public function installDefaultFeedProductSettings($feed_id = false, $feedMode = 'c')
    {
        ...
        if ($feedMode == 'g' || $feedMode == 'y' || $feedMode == 't' || $feedMode == 'ins'
            || $feedMode == 'onb' || $feedMode == 'cj' || $feedMode == 'fav' || $feedMode == 'tc' || $feedMode == 'lyst'
            || $feedMode == 'wb' || $feedMode == 'ikx' || $feedMode == 'pb' || $feedMode == 'cri' || $feedMode == 'pm'
            ...
            || $feedMode == 'em' || $feedMode == 'kl' || $feedMode == 'lr' || $feedMode == 'chb' || $feedMode == 'iem') {
            $feedMode = 'f';
        }

        if ($feedMode == 'bp' || $feedMode == 'sf') {
            $feedMode = 's';
        }

        if ($feedMode == 'pp' || $feedMode == 'hi' || $feedMode == 'ld' || $feedMode == 'pa' || $feedMode == 'ko'
            || $feedMode == 'pdk') {
            $feedMode = 'p';
        }
        ...
        if ($feedMode == 'cat' || $feedMode == 'publ' || $feedMode == 'dar' || $feedMode == 'ibs'
            || $feedMode == 'ven') {
            $feedMode = 'mir';
        }
        ...
        $fields['k'] = '
            ...
            ("ean13", 1, "gtin", "product", "' . $feed_id . '"),
            ("reference", 1, "mpn", "product", "' . $feed_id . '"),
            ("price_shipping_blmod", 1, "delivery_cost", "bl_extra", "' . $feed_id . '"),
            ("available_for_order", 1, "availability", "product", "' . $feed_id . '"),
            ("additional_product_url_blmod", 1, "landing_page_url", "bl_extra", "' . $feed_id . '"),
            ("quantity", 0, "stock_quantity", "product", "' . $feed_id . '"),
        ...
        $fields['cen'] = '
            ...
            ("condition", 1, "condition", "product", "' . $feed_id . '"),
            ("available_for_order", 1, "stock", "product", "' . $feed_id . '"),
            ("price_shipping_blmod", 1, "deliveryCost", "bl_extra", "' . $feed_id . '")';
        ...
        $fields['lb'] = '
            ...
            ("large", 1, "image", "img_blmod", "' . $feed_id . '"),
            ("id_product", 1, "product_id", "product", "' . $feed_id . '"),
            ("price_sale_blmod", 1, "sale_price", "bl_extra", "' . $feed_id . '"),
            ("price_sale_tax_excl_blmod", 1, "sale_price_tax_excl", "bl_extra", "' . $feed_id . '"),
            ("product_url_blmod", 1, "url", "bl_extra", "' . $feed_id . '"),
            ("ean13", 1, "ean13", "product", "' . $feed_id . '"),
            ("quantity", 1, "quantity", "product", "' . $feed_id . '"),
            ("product_categories_tree", 1, "category_tree", "bl_extra", "' . $feed_id . '"),
        ...
        $fields['alz'] = '
            ...
            ("product_url_blmod", 1, "URL", "bl_extra", "' . $feed_id . '"),
            ("price_sale_blmod", 1, "PRICE_VAT", "bl_extra", "' . $feed_id . '"),
            ("quantity", 0, "STOCK", "product", "' . $feed_id . '"),
            ("name", 1, "CATEGORY", "category_lang", "' . $feed_id . '")';
        ...
        $fields['emag'] = '
            ...
            ("name", 1, "Brand", "manufacturer", "' . $feed_id . '"),
            ("product_url_blmod", 1, "ProductURL", "bl_extra", "' . $feed_id . '"),
            ("price_sale_blmod", 1, "SalePrice", "bl_extra", "' . $feed_id . '"),
            ("quantity", 1, "Stock", "product", "' . $feed_id . '"),
            ("ean13", 1, "EAN", "product", "' . $feed_id . '"),
            ("available_for_order", 1, "HandlingTime", "product", "' . $feed_id . '"),
            ("name", 1, "Category", "category_lang", "' . $feed_id . '")';

        $fields['ppa'] = '
            ("name", 1, "title", "product_lang", "' . $feed_id . '"),
            ("description_short", 1, "description", "product_lang", "' . $feed_id . '"),
            ("name", 1, "manufacturer", "supplier", "' . $feed_id . '"),
            ("reference", 1, "sku", "product", "' . $feed_id . '"),
            ("ean13", 1, "ean", "product", "' . $feed_id . '"),
            ("unit", 1, "unit", "bl_extra", "' . $feed_id . '"),
            ("price_sale_tax_excl_blmod", 1, "warehouse/price_without_vat", "bl_extra", "' . $feed_id . '"),
            ("tax_rate", 1, "warehouse/vat_value", "bl_extra", "' . $feed_id . '"),
            ("quantity", 1, "warehouse/quantity", "product", "' . $feed_id . '"),
            ("names_of_all_categories", 1, "categories", "bl_extra", "' . $feed_id . '")';

        $fields['ve'] = '
            ("id_product", 1, "id", "product", "' . $feed_id . '"),
            ("name", 1, "name", "product_lang", "' . $feed_id . '"),
            ("description_short", 1, "description", "product_lang", "' . $feed_id . '"),
            ("name", 1, "brand", "supplier", "' . $feed_id . '"),
            ("reference", 1, "barcode", "product", "' . $feed_id . '"),
            ("ean13", 1, "gtin", "product", "' . $feed_id . '"),
            ("quantity", 1, "quantity_in_stock", "product", "' . $feed_id . '"),
            ("weight", 1, "weight", "product", "' . $feed_id . '"),
            ("name", 1, "categories", "category_lang", "' . $feed_id . '"),
            ("price_sale_blmod", 1, "sale_price", "bl_extra", "' . $feed_id . '"),
            ("price_wt_discount_blmod", 1, "price", "bl_extra", "' . $feed_id . '"),
            ("availability_label", 1, "availability", "bl_extra", "' . $feed_id . '")';

        $fields['lh'] = '
            ("id_product", 1, "OFFERID", "product", "' . $feed_id . '"),
            ("name", 1, "NAME", "product_lang", "' . $feed_id . '"),
            ("description_short", 1, "DESCRIPTION_SHORT", "product_lang", "' . $feed_id . '"),
            ("description", 1, "DESCRIPTION", "product_lang", "' . $feed_id . '"),
            ("name", 1, "BRAND", "manufacturer", "' . $feed_id . '"),
            ...
            ("product_url_blmod", 1, "LINK", "bl_extra", "' . $feed_id . '"),
            ("product_categories_tree", 1, "CATEGORY_PATH", "bl_extra", "' . $feed_id . '"),
            ("price_shipping_blmod", 0, "PRICE_DELIVERY", "bl_extra", "' . $feed_id . '"),
            ("availability_label", 1, "AVAILABILITY_TIME_DAYS", "bl_extra", "' . $feed_id . '")';
        ...
        $fields['le'] = '
            ...
            ("description", 1, "description", "product_lang", "' . $feed_id . '"),
            ("name", 1, "brand", "manufacturer", "' . $feed_id . '"),
            ("price", 1, "sale_price", "product", "' . $feed_id . '"),
            ("product_url_blmod", 1, "product_URL", "bl_extra", "' . $feed_id . '"),
            ("product_categories_tree", 1, "category", "bl_extra", "' . $feed_id . '"),
            ("price_shipping_blmod", 0, "delivery_costs", "bl_extra", "' . $feed_id . '"),
            ("reference", 1, "MPN", "product", "' . $feed_id . '"),
            ...
            ("condition", 1, "condition", "product", "' . $feed_id . '"),
            ("weight", 1, "weight", "product", "' . $feed_id . '"),
            ("availability_label", 0, "Availability", "bl_extra", "' . $feed_id . '")';

        $fields['ps'] = '
            ("id_product", 1, "internalId", "product", "' . $feed_id . '"),
            ("name", 1, "name", "product_lang", "' . $feed_id . '"),
            ("description", 1, "note1", "product_lang", "' . $feed_id . '"),
            ("name", 1, "brand", "manufacturer", "' . $feed_id . '"),
            ("price", 1, "price", "product", "' . $feed_id . '"),
            ("product_categories_tree", 1, "category", "bl_extra", "' . $feed_id . '"),
            ("reference", 1, "sku", "product", "' . $feed_id . '"),
        ...
        $blocks['lb'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "products", "1", "' . $feed_id . '"),
        ...
        $blocks['alz'] = '("desc-block-name", "DESCRIPTIONS", "1", "' . $feed_id . '"),
            ("img-block-name", "IMAGES", "1", "' . $feed_id . '"),
            ("cat-block-name", "SHOPITEM", "1", "' . $feed_id . '"),
            ("file-name", "SHOP", "1", "' . $feed_id . '"),
            ("def_cat-block-name", "CATEGORIES", "1", "' . $feed_id . '"),
        ...
        $blocks['emag'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "products", "1", "' . $feed_id . '"),
        ...
        $blocks['ve'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "products", "1", "' . $feed_id . '"),
        ...
        $blocks['ppa'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "mywebstore", "0", "' . $feed_id . '"),
            ("def_cat-block-name", "default_category", "1", "' . $feed_id . '"),
            ("attributes-block-name", "attributes", "1", "' . $feed_id . '")';

        $blocks['lh'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "products", "1", "' . $feed_id . '"),
            ("def_cat-block-name", "default_category", "1", "' . $feed_id . '"),
            ("attributes-block-name", "attributes", "1", "' . $feed_id . '"),
            ("extra-product-rows", "' . htmlspecialchars('<CURRENCY>EUR</CURRENCY>', ENT_QUOTES) . '", "1", "' . $feed_id . '")';

        $blocks['le'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "products", "1", "' . $feed_id . '"),
        ...
        $blocks['ps'] = '("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("img-block-name", "images", "1", "' . $feed_id . '"),
            ("desc-block-name", "descriptions", "1", "' . $feed_id . '"),
            ("cat-block-name", "product", "1", "' . $feed_id . '"),
            ("file-name", "products", "1", "' . $feed_id . '"),
        ...
        $options['cen'] = 'one_branch = "1", all_images = "0", cdata_status = "1", in_stock_text = "in stock", out_of_stock_text = "out of stock", on_demand_stock_text = "out of stock"';
        ...
        $options['wor'] = 'header_information = "' . htmlspecialchars('<import>', ENT_QUOTES) . '", in_stock_text = "3", out_of_stock_text = "5",
			footer_information = "' . htmlspecialchars('</import>', ENT_QUOTES) . '", one_branch = "1", cdata_status = "1"';
        $options['lb'] = 'one_branch = "1", all_images = "0", cdata_status = "1"';
        $options['alz'] = 'one_branch = "1", all_images = "0", cdata_status = "1"';
        $options['emag'] = 'one_branch = "1", all_images = "0", cdata_status = "1"';
        $options['ve'] = 'one_branch = "1", all_images = "1", cdata_status = "1", price_with_currency = "1"';
        $options['ppa'] = 'one_branch = "1", all_images = "1", cdata_status = "1", header_information = "'.htmlspecialchars('<mywebstore><vendor_info>
<vat_number>ENTER_YOUR_VAT_NUMBER</vat_number>
<brand_name>ENTER_YOUR_BRAND_NAME</brand_name>
</vendor_info>', ENT_QUOTES).'", footer_information = "' . htmlspecialchars('</mywebstore>', ENT_QUOTES) . '"';
        $options['lh'] = 'one_branch = "1", all_images = "1", cdata_status = "1"';
        $options['le'] = 'one_branch = "1", all_images = "1", cdata_status = "1"';
        $options['ps'] = 'header_information = "' . htmlspecialchars('<channel>', ENT_QUOTES) . '", footer_information = "' . htmlspecialchars('</channel>', ENT_QUOTES) . '", one_branch = "1", all_images = "1", cdata_status = "1"';
        ...
        $imageName['lb'] = 'image_link';
        $imageName['emag'] = 'ImageURL';
        $imageName['ve'] = 'picture';
        $imageName['ppa'] = 'image';
        $imageName['lh'] = 'image_URL';
        $imageName['ps'] = 'image_1_url';
        ...
        if (in_array($feedMode, ['ve',])) {
            $feedMeta = new FeedMeta();
            $meta = $feedMeta->getFeedMeta($feed_id);
            $meta[$feed_id]['label_in_stock_text'] = 'in stock';
            $meta[$feed_id]['label_out_of_stock_text'] = 'out of stock';
            $meta[$feed_id]['additional_image_name'] = 'additional_images';
            $meta[$feed_id]['attribute_structure_id'] = 2;
            $feedMeta->saveFromArray($feed_id, $meta[$feed_id]);
        }

        if (in_array($feedMode, ['lh',])) {
            $feedMeta = new FeedMeta();
            $meta = $feedMeta->getFeedMeta($feed_id);
            $meta[$feed_id]['category_tree_separator'] = '\\';
            $feedMeta->saveFromArray($feed_id, $meta[$feed_id]);
        }
    ...
    public function installDefaultFeedOrderSettings($feedId, $isReadyPro = false)
    {
        $feedId = (int)$feedId;
        ...
        Db::getInstance()->Execute('UPDATE '._DB_PREFIX_.'blmod_xml_feeds 
            SET filter_date_type = "'.(int)OrderSettings::FILTER_DATE_THIS_MONTH.'" 
            WHERE id = "'.$feedId.'"');
    ...
    public function upgrade31011()
    {
        Db::getInstance()->Execute('ALTER TABLE '._DB_PREFIX_.'blmod_xml_category_map ADD `use_category_id` TINYINT(1) NOT NULL DEFAULT "0"');
    }

    public function upgrade3128()
    {
        Db::getInstance()->Execute('CREATE TABLE IF NOT EXISTS ' . _DB_PREFIX_ . 'blmod_xml_configuration
			(
