...
class XmlFeedsTools
{
    ...
    public static function jsonSerializeDecode($string)
    {
        if (!empty($string)) {
    ...
    public static function iSMinqcValid()
    {
        $results = Db::getInstance()->ExecuteS('SHOW TABLES LIKE "'._DB_PREFIX_.'minqc"');
