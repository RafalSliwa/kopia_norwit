...
<div class="panel">
    ...
    <a class="menu-top-item mb15{if $currentPage.type == 'add_feed' && $currentPage.id == 1} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&add_feed=1{$token|escape:'htmlall':'UTF-8'}"><i class="icon-plus-circle menu-top-item-icon"></i>{l s='Add new feed' mod='xmlfeeds'}</a>
    <a class="menu-top-item{if $currentPage.type == 'add_affiliate_price'} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&add_affiliate_price=1{$token|escape:'htmlall':'UTF-8'}"><i class="icon-calculator menu-top-item-icon"></i>{l s='Affiliate prices' mod='xmlfeeds'}</a>
    ...
    <div>
        ...
        <div class="menu-top-feeds">
            {if !empty($categories)}
                {foreach $categories as $c}
                    <div class="menu-top-item">
                        <a class="menu-top-item-title{if $currentPage.type == 'edit' && $currentPage.id == $c.id} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&page={$c.id|escape:'htmlall':'UTF-8'}{$token|escape:'htmlall':'UTF-8'}">{$c.name|escape:'htmlall':'UTF-8'}</a>
        ...
        <a class="menu-top-item{if $currentPage.type == 'add_feed' && $currentPage.id == 2} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&add_feed=2{$token|escape:'htmlall':'UTF-8'}"><i class="icon-plus-circle menu-top-item-icon"></i>{l s='Add new feed' mod='xmlfeeds'}</a>
        <div>
            <hr/>
        ...
        <a class="menu-top-item{if $currentPage.type == 'add_feed' && $currentPage.id == 3} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&add_feed=3{$token|escape:'htmlall':'UTF-8'}"><i class="icon-plus-circle menu-top-item-icon"></i>{l s='Add new feed' mod='xmlfeeds'}</a>
        <hr/>
        <div>
            <a class="menu-top-item{if $currentPage.id == 4} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&page=4{$token|escape:'htmlall':'UTF-8'}"><i class="icon-user menu-top-item-icon"></i>{l s='Export customers' mod='xmlfeeds'}</a>
        </div>
        <div>
            <a class="menu-top-item{if $currentPage.id == 5} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&page=5{$token|escape:'htmlall':'UTF-8'}"><i class="icon-flag menu-top-item-icon"></i>{l s='Export brands' mod='xmlfeeds'}</a>
        </div>
        <div>
            <a class="menu-top-item{if $currentPage.id == 6} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&page=6{$token|escape:'htmlall':'UTF-8'}"><i class="icon-truck menu-top-item-icon"></i>{l s='Export suppliers' mod='xmlfeeds'}</a>
        </div>
        <div>
            <a class="menu-top-item{if $currentPage.type == 'about_page'} menu-a{/if}" style="display: inline-block;" href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&about_page=1{$token|escape:'htmlall':'UTF-8'}"><i class="icon-info-circle menu-top-item-icon"></i>{l s='About' mod='xmlfeeds'}</a>
        </div>
    </div>
</div><br/><br/>