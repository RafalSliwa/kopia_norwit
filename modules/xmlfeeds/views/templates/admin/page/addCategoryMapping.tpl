...
<script type="text/javascript">
    let ga_cat_blmod = [{$categoriesList}];
</script>
<div class="panel">
    ...
    <div class="row">
        ...
        <form action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post">
            ...
            <div>
                <table>
                    <tr>
                        <td>{l s='Use category ID instead of name' mod='xmlfeeds'}</td>
                        <td>
                            <label style="margin-left: 15px;">
                                {include file="{$tpl_dir}/views/templates/admin/helper/status.tpl" id='use_category_id' name='use_category_id' status=$useCategoryId}
                            </label>
                        </td>
                    </tr>
                </table>
                    ...
                    {foreach $categoriesTree as $c}
                        <tr class="">
                            ...
                            <td>
                                ...
                                <div>
                                    <input type="text" placeholder="Enter category name" id="google_cat_map_{$c.id|escape:'htmlall':'UTF-8'}" class="google_cat_map_blmod" name="google_cat_map[{$c.id|escape:'htmlall':'UTF-8'}]" value="{$c.googleCatValue|escape:'htmlall':'UTF-8'}">
                                </div>
                                <div style="clear: both;"></div>
                            </td>
                        </tr>
