        ...
        <div class="row">
            <table border="0" width="100%" cellpadding="3" cellspacing="0">
                ...
                {if $feed_type eq '3'}
                    ...
                    <tr>
                        <td class="settings-column-name" style="width: 110px;">
                            <img style="padding-right: 0;" src="../modules/xmlfeeds/views/img/readypro-logo.png">
                        </td>
                        <td>
                            <label>
                                {include file="{$tpl_dir}/views/templates/admin/helper/status.tpl" id='is_ready_pro' name='is_ready_pro'}
                            </label>
                        </td>
                    </tr>
                {/if}
            ...
            {if $feed_type eq '1'}
                ...
                <tr>
                    <td class="settings-column-name al-t" style="width: 25px;">
                        <br>
                    </td>
                    <td>
                        <div class="option-box-title blmod_m20 cd">{l s='The most popular templates:' mod='xmlfeeds'}</div>
                        ...
                        <div class="option-box-title blmod_m20 cd">{l s='Templates sorted alphabetically:' mod='xmlfeeds'}</div>
            ...
            <center>
                <div id="search-type-controller-url" style="display: none;">{$searchTypeControllerUrl|escape:'htmlall':'UTF-8'}</div>
