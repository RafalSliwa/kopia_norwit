    ...
    <div class="bootstrap">
        <form action="{$postUrl|escape:'htmlall':'UTF-8'}" method="post">
            ...
            {if !empty($productListId)}
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <i class="icon-folder-open"></i> {l s='Search by product name' mod='xmlfeeds'}
                    </div>
                    <div class="row">
                        <div class="">
                            <input id="search_form_id" autocomplete="off" type="text" class="search_form" name="product" value="" size="50" placeholder="Title element">
                            <div class="search_types" style="margin-bottom: 10px;">
                                <label class="blmod_mr15">
                                    <input id="search_name" type="radio" name="search_type" value="search_name" checked="checked"> <span>Name starts with</span>
                                </label>
                                <label class="blmod_mr15">
                                    <input id="search_id" type="radio" name="search_type" value="search_id"> <span>Name ends with</span>
                                </label>
                                <label>
                                    <input id="search_id" type="radio" name="search_type" value="search_id"> <span>Any part of the name</span>
                                </label>
                                <div class="cb"></div>
                            </div>
                        </div>
