...
<div class="title-editor-type">
    <div class="title-editor-type-name">{l s='Add text before title' mod='xmlfeeds'}</div>
    <div>
        <input style="width: 100%;" type="text" name="title_editor_text_before" value="{$s.title_editor_text_before|escape:'htmlall':'UTF-8'}">
    </div>
</div>
<div class="title-editor-type">
    <div class="title-editor-type-name">{l s='Add text after title' mod='xmlfeeds'}</div>
    <div>
        <input style="width: 100%;" type="text" name="title_editor_text_after" value="{$s.title_editor_text_after|escape:'htmlall':'UTF-8'}">
    </div>
</div>
<div class="title-editor-type">
    ...
    <div>
        {foreach $productTitleEditorElementsList as $k => $n}
            <label class="attribute-list" style="margin-bottom: 5px!important;">
...
<div class="title-editor-type">
    <div class="title-editor-type-name">{l s='Attributes separator' mod='xmlfeeds'}</div>
    <div class="mb10">
        <input style="width: 150px;" type="text" name="title_attribute_separator" value="{$s.title_attribute_separator|escape:'htmlall':'UTF-8'}">
    </div>
    <div class="cb"></div>
</div>
<div class="title-editor-type">
