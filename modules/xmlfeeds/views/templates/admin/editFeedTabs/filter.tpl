...
<table border="0" width="100%" cellpadding="3" cellspacing="0">
    ...
    <tr>
        <td class="settings-column-name">{l s='Updared for the last XX days' mod='xmlfeeds'}</td>
        <td>
            <input class="price_range_field" type="text" name="filter_updated_before_days" value="{$s.filter_updated_before_days|escape:'htmlall':'UTF-8'}" placeholder="{l s='Number of days' mod='xmlfeeds'}">
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <div class="categories_without_list" style="display: none; margin-top: 20px;">
                ...
                <table cellspacing="0" cellpadding="0" class="table blmod-table-light table-no-space" id="radio_div" style="">
                    ...
                    {if !empty($categoriesTreeL)}
                        {foreach $categoriesTreeL as $c}
                            <tr class="">
                                <td class="center">
                                    <input type="checkbox" id="categoryWithoutBox_{$c.id|escape:'htmlall':'UTF-8'}" name="categoryWithoutBox[]" value="{$c.id|escape:'htmlall':'UTF-8'}" class="noborder" {if !empty($c.is_checked)} checked="checked"{/if}>
                                </td>
                                <td style="">
                                    {$c.id|escape:'htmlall':'UTF-8'}
                                </td>
