 ...
 *
 * @author    Bl Modules
 * @copyright 2010-2024 Bl Modules
 * @license
 *
 */
...
$(document).ready(function() {
	...
	$('#use_cron').click(function() {
		if ($(this).prop("checked")) {
			$('#cron-file-name-box').show();
		} else {
			$('#cron-file-name-box').hide();
		}
	});

	$('#all_images').click(function() {
		if ($(this).prop("checked")) {
			$('#additional-image-name-box').show();
		} else {
			$('#additional-image-name-box').hide();
		}
	});
});
