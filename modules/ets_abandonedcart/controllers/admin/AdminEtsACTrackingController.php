...
class AdminEtsACTrackingController extends AdminEtsACFormController
{
    ...
    public function initToolbarTitle()
    {
        if (!$this->display || $this->display == 'view') {
            $this->toolbar_title = array($this->module->l('Campaign tracking', 'AdminEtsACTrackingController', null, null, false));
            if (is_array($this->meta_title)) {
                $this->meta_title = array($this->module->l('Campaign tracking', 'AdminEtsACTrackingController', null, null, false));
            }
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('clearTracking')) {
            if (EtsAbancartTracking::setDelete()) {
                $this->context->cookie->ets_ac_tracking_success = $this->module->l('Clear tracking successfully', 'AdminEtsACTrackingController');
            } else
                $this->context->cookie->ets_ac_tracking_error = $this->module->l('Clear tracking failed', 'AdminEtsACTrackingController');
