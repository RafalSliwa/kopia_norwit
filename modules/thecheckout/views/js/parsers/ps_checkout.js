...
/* Tested with ps_checkout v7.5.0.2 and v8.5.0.2 (16.09.2025)
   Fix necessary: /modules/ps_checkout/ps_checkout.php, around line 675, in method hookDisplayPaymentByBinaries add:
        if (!$cart->id_customer) {
            return '';
        }
*/
