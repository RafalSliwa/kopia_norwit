...
<div id="pm_backoffice_wrapper" class="pm_bo_ps_{$ps_major_version|escape:'htmlall':'UTF-8'} pm_bo_ps_{$ps_version_full|escape:'htmlall':'UTF-8'}">
    ...
    {if !count($permissions_errors)}
        {if $module_is_up_to_date}
            {if $context_is_shop}
                ...
                {as4_button text={l s='General settings' mod='pm_advancedsearch4'} href="#" onclick="window.scrollTo({ top: document.querySelector('.pmGlobalConfigurationTabs').getBoundingClientRect().top + window.scrollY - 140, behavior: 'smooth' });" class='pmAsSettingsAnchorButton btn-default' rel='980_530_1' icon_class='settings'}
                <br />
                <br />
                <div id="wrapAsTab">
                ...
                <div id="msgNoResults" style="{if is_array($search_engines) && count($search_engines)}display:none{/if}">
                ...
                <div class="form-wrapper pmGlobalConfigurationTabs">
                    <div class="panel">
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a href="#config-5" data-toggle="tab">
                                    <span><i class="material-icons">speed</i>{l s='Performance' mod='pm_advancedsearch4'}</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content panel">
                            ...
                            <div id="config-5" class="tab-pane">
                                {$performance_tab|as4_nofilter}
                            </div>
    ...
    {else}
        {module->showWarning text="
            ...
            {implode('<br />', $permissions_errors)|as4_nofilter}
        "}
    {/if}
