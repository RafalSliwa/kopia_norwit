...
<div id="searchTabContainer-{$id_search|intval}" class="searchTabContainer">
    <div class="searchSort">
        <div class="search-actions-buttons">
            {as4_button text={l s='Settings' mod='pm_advancedsearch4'} href="{$base_config_url|as4_nofilter}&pm_load_function=displaySearchForm&class=Models\Search&pm_js_callback=closeDialogIframe&id_search={$search_engine.id_search}" class='open_on_dialog_iframe' rel='980_530_1' icon_class='settings'}
            ...
            {if $hasMultipleShops}
                {as4_button text={l s='Duplicate' mod='pm_advancedsearch4'} href="{$base_config_url|as4_nofilter}&pm_load_function=displayDuplicateSearchForm&id_search={$search_engine.id_search}" class='open_on_dialog_iframe' rel='700_350' icon_class='content_copy'}
            {else}
