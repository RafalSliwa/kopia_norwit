...
{if $as_search.reset_group|intval && empty($criterions_group.prevent_reset) && isset($as_search.selected_criterion[$criterions_group.id_criterion_group]) && sizeof($as_search.selected_criterion[$criterions_group.id_criterion_group])}
...
{if $as_search.step_search
    ...
    empty($as_search.step_search_next_in_disabled) && !empty($as_search.hide_empty_crit_group))
}
