...
**********************}
{if isset($as_search.selected_criterions_ld[$criterions_group.id_criterion_group]) && in_array($criterion.id_criterion_linked, $as_search.selected_criterions_ld[$criterions_group.id_criterion_group])}
...
{else}
	...
	<li class="{if isset($as_criterion_is_selected) && $as_criterion_is_selected}PM_ASCriterionLevelSelected {/if}{if isset($as_criterion_selected) && $as_criterion_selected}PM_ASCriterionLevelChoosen {/if}PM_ASCriterionLevel level{$level_depth|intval}"
		...
		{else}
			{if isset($as_search.selected_criterions_ld[$criterions_group.id_criterion_group]) && in_array($criterion.id_parent, $as_search.selected_criterions_ld[$criterions_group.id_criterion_group])}
