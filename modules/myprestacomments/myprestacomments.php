...
class myprestacomments extends Module
{
    ...
    public function install($keep = true)
    {
        ...
        if (parent::install() == false ||
            ...
            !Configuration::updateValue('PRODUCT_COMMENTS_POSITION', 'productFooter') ||
            ...
            !Configuration::updateValue('PRODUCT_COMMENTS_NB_SHOW', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENTS_LIST', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENTS_LIST_ALL', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENTS_GDPR', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENTS_DGRADE', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENT_DATE', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENT_TITLE', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENT_BODY', 1) ||
            !Configuration::updateValue('PRODUCT_COMMENT_AUTHOR', 1)) {
            return false;
        }
    ...
    public function uninstall($keep = true)
    {
        if (!parent::uninstall() || ($keep && !$this->deleteTables()) || 
            !Configuration::deleteByName('PRODUCT_COMMENTS_POSITION') || 
            ...
            !Configuration::deleteByName('PRODUCT_COMMENTS_NB_SHOW') ||
            !Configuration::deleteByName('PRODUCT_COMMENTS_LIST') ||
            !Configuration::deleteByName('PRODUCT_COMMENTS_LIST_ALL') ||
            !Configuration::deleteByName('PRODUCT_COMMENTS_GDPR') ||
            !Configuration::deleteByName('PRODUCT_COMMENTS_DGRADE') ||
            !Configuration::deleteByName('PRODUCT_COMMENT_DATE') ||
            !Configuration::deleteByName('PRODUCT_COMMENT_TITLE') ||
            !Configuration::deleteByName('PRODUCT_COMMENT_BODY') ||
            !Configuration::deleteByName('PRODUCT_COMMENT_AUTHOR') ||
            !$this->unregisterHook('displayRightColumnProduct') || 
            !$this->unregisterHook('displayHeader') || !$this->unregisterHook('productFooter') || !$this->unregisterHook('top') || !$this->unregisterHook('displayProductListReviews')) {
            return false;
        }
    ...
    public function renderCommentsForm($params)
    {
        ...
        $cover_image = $this->context->link->getImageLink($product->link_rewrite, $image ? $image['id_image'] : '', 'medium_default');
        ...
        $this->context->smarty->assign(array(
            ...
            //'MyprestaComment_cover' => (int)Tools::getValue('id_product') . '-' . $image ? (int)$image['id_image'] : '',
