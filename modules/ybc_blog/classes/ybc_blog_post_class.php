...
class Ybc_blog_post_class extends ObjectModel
{
    ...
    public static function getProductsByIDs($id_products)
    {
        if ($id_products) {
            ...
            if ($product_list) {
                $type_image = Ybc_blog::getFormattedName('small');
    ...
    public static function getProductInfo($id_product)
    {
        ...
        $pinfo['img_url'] = Context::getContext()->link->getImageLink($product->link_rewrite, $id_image, Ybc_blog::getFormattedName('home'));
