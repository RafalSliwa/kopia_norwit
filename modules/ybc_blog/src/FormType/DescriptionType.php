...
namespace Ets\YbcBlog\FormType;
...
class YbcDescriptionType extends DescriptionType
{
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults([
            ...
            'form_theme' => '@PrestaShop/Modules/YbcBlog/FormTheme/product_description.html.twig',
            'product_id'=>null,
        ])
            ->setRequired([
                'product_id',
