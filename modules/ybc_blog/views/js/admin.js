...
$(document).ready(function(){
   ...
   $(document).on('click','.checkbox input',function(){
    ...
    $(document).on('click','.btn-check-api-key-gpt',function(e){
        e.preventDefault();
        var chatGptKey = $('#YBC_BLOG_API_GPT').val();
        if(chatGptKey && !$(this).hasClass('loading'))
        {
            ...
            $.ajax({
                ...
                success: function(json){
                    ...
                    $('.btn-check-api-key-gpt').removeClass('loading');
                },
                error: function(error)
                {
...
function showSaveMessage(message, type)
{
    ...
    $('.ybc_blog_alert').addClass('hidden').removeClass('error').removeClass('success').addClass(type=='error' ? 'error' : 'success').html(message).append('<span class="close_alert"></span>').removeClass('hidden');
    if(type!='error')
    {        
        setTimeout(function(){
            $('.ybc_blog_alert').addClass('hidden');
