...
{if isset($categoires) && $categoires}
    {foreach from=$categoires item='category'}
        {if isset($category.posts) && $category.posts}
            <div class="block ybc_block_category {$blog_config.YBC_BLOG_RTL_CLASS|escape:'html':'UTF-8'}
{if isset($blog_page) && $blog_page}page_{$blog_page|escape:'html':'UTF-8'}{else}page_blog{/if}
{if isset($blog_page) && $blog_page=='home'}
    {if isset($blog_config.YBC_BLOG_HOME_POST_TYPE) && $blog_config.YBC_BLOG_HOME_POST_TYPE=='default' || count($category.posts)<=1}ybc_block_default{else}ybc_block_slider{/if}
{else}
    {if isset($blog_config.YBC_BLOG_SIDEBAR_POST_TYPE) && $blog_config.YBC_BLOG_SIDEBAR_POST_TYPE=='default' || count($category.posts)<=1}ybc_block_default{else}ybc_block_slider{/if}
{/if}">
                ...
                <div class="ybc_blog_content_block {if isset($blog_page) && $blog_page=='home'}
    {if isset($blog_config.YBC_BLOG_HOME_POST_TYPE) && $blog_config.YBC_BLOG_HOME_POST_TYPE=='default' || count($category.posts)<=1}ybc_block_default{else}blog_type_slider{/if}
{else}
    {if isset($blog_config.YBC_BLOG_SIDEBAR_POST_TYPE) && $blog_config.YBC_BLOG_SIDEBAR_POST_TYPE=='default' || count($category.posts)<=1}ybc_block_default{else}blog_type_slider{/if}
{/if}">{foreach from=$category.posts item='post'}
...
{*                                <a class="read_more" href="{$post.link|escape:'html':'UTF-8'}">{if $blog_config.YBC_BLOG_TEXT_READMORE}{$blog_config.YBC_BLOG_TEXT_READMORE|escape:'html':'UTF-8'}{else}{l s='Read More' mod='ybc_blog'}{/if}</a>*}
                                ...
                                {if $blog_config.YBC_BLOG_TEXT_READMORE}
                                    <a class="read_more" href="{$post.link|escape:'html':'UTF-8'}">{$blog_config.YBC_BLOG_TEXT_READMORE|escape:'html':'UTF-8'}</a>
                                {/if}
