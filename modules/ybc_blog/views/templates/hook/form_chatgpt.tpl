...
*}
<div class="ybc-chatgpt-box panel resize minimize" style="display:none">
    <div class="panel-heading">
        ...
        </i> {l s='ChatGPT' mod='ybc_blog'}
        <div class="maximize-chat-gpt" title="{l s='Maximize' mod='ybc_blog'}">
        ...
        <div class="minimize-chat-gpt" title="{l s='Minimize' mod='ybc_blog'}">
        ...
        <div class="close-chatgpt-box" title="{l s='Close' mod='ybc_blog'}">{l s='Close' mod='ybc_blog'}</div>
    </div>
    <div class="box-actions">
        <button class="btn-clear-all-message"{if !$chatgpt_messages} style="display: none;"{/if}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M290.7 57.4L57.4 290.7c-25 25-25 65.5 0 90.5l80 80c12 12 28.3 18.7 45.3 18.7H288h9.4H512c17.7 0 32-14.3 32-32s-14.3-32-32-32H387.9L518.6 285.3c25-25 25-65.5 0-90.5L381.3 57.4c-25-25-65.5-25-90.5 0zM297.4 416H288l-105.4 0-80-80L227.3 211.3 364.7 348.7 297.4 416z"/></svg> {l s='Clear all prompt' mod='ybc_blog'}</button>
    </div>
    ...
    <div class="chatgpt-box-send">
        <textarea name="message-chatppt" placeholder="{l s='Send a message... ' mod='ybc_blog'}"></textarea>
                        ...
                        <ul class="gpt-list-templates">
                            {foreach from=$gpt_templates[$language.id_lang] item='template'}
                                {if $template.label && $template.content}
                                    <li class="gpt-item-template" data-content="{$template.content|escape:'html':'UTF-8'}">{$template.label|escape:'html':'UTF-8'}</li>
                                {/if}
                            {/foreach}
                        </ul>
                    {/if}
    ...
    <div class="panel-footer">
        <button type="button" value="1" class="btn btn-default pull-right btn-send-gpt">
            {l s='Send' mod='ybc_blog'}
        </button>
    </div>
</div>