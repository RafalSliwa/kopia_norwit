...
<div class="row">
    <div class="col-lg-12">
        <div class="alert alert-warning">
            <p>{l s='Tytuł zostanie zaktualizowany we wszystkich zaznaczonych ofertach (lub licytacjach, jeśli nikt nie zaczął licytować).' mod='x13allegro'}</p>
            <p>{l s='Tytuł nie może być którszy niż %d znaków i musi zawierać co najmniej %d słowa.' mod='x13allegro' sprintf=[$data.titleMinSize, $data.titleMinWords]}</p>
            <p>{l s='Jeśli nowo wygenerowany tytuł będzie dłuższy niż %d znaków, zostanie on automatycznie skrócony.' mod='x13allegro' sprintf=[$data.titleMaxSize]}</p>
        </div>
    </div>
</div>
