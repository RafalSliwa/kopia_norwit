        ...
        <div class="modal-content">
            ...
            <div class="modal-footer x13allegro-modal-footer">
                <div class="x13allegro-modal-footer-left">
                    ...
                    <span class="x13allegro-category-parameters-info-trusted"><i class="icon-lock"></i></span> - zaufany parametr z <strong>Katalogu Allegro</strong> (zablokowana możliwość edycji)<br/>
