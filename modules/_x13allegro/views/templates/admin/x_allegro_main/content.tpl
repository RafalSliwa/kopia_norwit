...
{if isset($products) && !empty($products)}
                        ...
                        {foreach $products AS $index => $product}
                            ...
                            >
                                ...
                                <td colspan="{if !$product.disabled}5{else}7{/if}" style="border-bottom: 1px dashed #DDD;vertical-align:middle;">
                                        ...
                                        {if !$product.disabled}
                                            <div class="xproductization-all-info">
                                                ...
                                                <div class="xproductization-trusted-content"
                                                     style="font-size: 11px; color: #999; display: none;"
                                                     data-trusted-content-name="{l s='nazwa' mod='x13allegro'}"
                                                     data-trusted-content-category="{l s='kategoria' mod='x13allegro'}"
                                                     data-trusted-content-images="{l s='zdjęcia' mod='x13allegro'}"
                                                     data-trusted-content-description="{l s='opis' mod='x13allegro'}"
                                                >
                                                    {l s='Zaufana zawartość' mod='x13allegro'}:
                                                    <span class="xproductization-trusted-content-paths"></span>
                                                </div>
                                        </div>
                                        {/if}
                                    </label>
                                    ...
                                    <div class="xproductization-indicator-wrapper">
                                        {if !$product.disabled}
                                            <div class="text-right xproductization-indicator-wrapper-all">
                                                ...
                                                <span class="xproductization-mode-selector">
                                                    <select name="item[{$index}][productization_mode]" x-name="productization_mode" class="fixed-width-xxl" data-current="ASSIGN" disabled="disabled">
                                        ...
                                        {/if}
                                        <div class="x13allegro-product-auctio-count">{if $product.allegro_status && $product.allegro_status.count > 0}Wystawiono:<span class="x13allegro-product-auctio-count-small"> {$product.allegro_status.quantity} szt. na {$product.allegro_status.count} {if $product.allegro_status.count == 1}ofercie{else}ofertach{/if}</span>{/if}</div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="{if $product.allegro_status && $product.allegro_status.count > 0}exposed{/if} {if $index is odd}alt_row odd{/if}" style="display: none;" x-name="product" x-id="{$index}">
                                <td colspan="2" style="vertical-align: top; padding-top:10px;">
                                    ...
                                    <input type="hidden" name="item[{$index}][allegro_product_trusted_content_name]" value="" x-name="allegro_product_trusted_content_name" />
                                    <input type="hidden" name="item[{$index}][allegro_product_trusted_content_images]" value="" x-name="allegro_product_trusted_content_images" />
                                    <input type="hidden" name="item[{$index}][allegro_product_trusted_content_description]" value="" x-name="allegro_product_trusted_content_description" />
                                    <input type="hidden" name="item[{$index}][allegro_product_trusted_content_category]" value="" x-name="allegro_product_trusted_content_category" />
                                    ...
                                    <div class="title-box">
                                        {if $productization_name == 'prestashop_copy' || $productization_name == 'allegro'}
                                            <a class="btn btn-default button bt-icon label-tooltip allegro-productization-name-copy hidden" style="display: none;" x-name="productization_name_copy" data-toggle="tooltip" data-original-title="Kopiuj nazwę produktu Allegro do tytułu oferty">
                                                <i class="icon-copy"></i>
                                            </a>
                                        {/if}
                                        ...
                                        <p>
                                            <span>
                                                Ilość znaków: <strong><span class="allegro-title-counter" x-name="counter">{$product.title_size}</span>/{$titleMaxSize}</strong>
                                                <span class="icon-warning label-tooltip allegro-title-counter-error" data-toggle="tooltip" data-html="true" data-original-title="" data-error-min="Minimalna ilość znaków: {$titleMinSize}" data-error-words="Minimalna ilość słów: {$titleMinWords}"></span>
                                            </span>
                                        </p>
                                    </div>
        ...
        <div id="bulk_container" class="row is-hidden" style="visibility: hidden;">
            <div class="panel col-lg-12" x-name="allegro_bulk">
                <fieldset>
                    ...
                    <div style="border-bottom: 1px solid #eee; padding: 0 10px 10px; margin-bottom: 15px;">
                        ...
                        <div class="bulk-mode-selector" style="float: right;">
                            <select x-name="bulk_productization_mode" class="fixed-width-xxl">
    ...
    <script type="text/javascript">
        ...
        XAllegro.productizationGPSR = '{$productization_gpsr}';
