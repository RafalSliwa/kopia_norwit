{if version_compare($smarty.const._PS_VERSION_, '1.7.0.0', '>')}
    {if isset($allegro_href) && !empty($allegro_href)}
        <div class="x13allegro-auction-link" style="margin-top: 10px;">
            <img src="{$allegro_img}" style="float: left; padding: 2px 4px 0 0;"><a href="{$allegro_href}" target="_blank" rel="nofollow">{l s='Zobacz na Allegro' mod='x13allegro'}</a>
        </div>
    {/if}
{else}
    <style>
