...
final class XAllegroSyncShipping extends XAllegroSync
{
    ...
    public static function getSyncShipping($checkBlockedStates = false, $offset = 0)
    {
        ...
        if ($checkBlockedStates) {
            $blockOrderSendShippingStatus = XAllegroConfiguration::get('BLOCK_ORDER_SEND_SHIPPING_STATUS');
            if ($blockOrderSendShippingStatus) {
                $orderStates = json_decode($blockOrderSendShippingStatus, true);
            }
        }
