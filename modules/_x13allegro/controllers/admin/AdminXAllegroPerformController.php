...
final class AdminXAllegroPerformController extends XAllegroController
{
    ...
    public function displayXEditLink($token = null, $id, $name = null)
    {
        if (version_compare(_PS_VERSION_, '1.7.0.0', '<')) {
            ...
            $href = $this->context->link->getAdminLink('AdminProducts', true, ['route' => 'admin_product_form', 'id' => $id]);
        } else {
            $href = $this->context->link->getAdminLink('AdminProducts', true, ['id_product' => $id]);
        }
