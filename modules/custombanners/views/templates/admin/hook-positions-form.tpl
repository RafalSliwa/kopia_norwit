...
<div class="panel clearfix module_list">
	<form action="" method="post" class="position-settings">
		<div class="title-container">
			{l s='Module positions for hook [1]%s[/1]' mod='custombanners' tags=['<span class="b">'] sprintf=$hook_name}
			<i class="icon-times hide-settings" title="{l s='Hide' mod='custombanners'}"></i>
		</div>
		<div class="alert alert-info">
			{l s='Drag modules in the list below to update positions' mod='custombanners'}
		</div>
