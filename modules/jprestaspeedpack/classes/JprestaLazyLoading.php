...
if (!class_exists('JprestaLazyLoading')) {
    ...
    class JprestaLazyLoading extends JprestaSubModule
    {
        ...
        {
            $logs = json_decode(Configuration::get('SPEED_PACK_LAZY_LOGS', null, null, null, array()));
            $logs[] = array('date' => date('Y-m-d H:i:s'), 'msg' => $line, 'type' => $type);
        ...
        {
            Configuration::updateValue('SPEED_PACK_LAZY_LOGS', json_encode(array()));
        }
