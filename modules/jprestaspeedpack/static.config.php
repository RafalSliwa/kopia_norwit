...
function jprestaIsMobileDevice() {
    if (file_exists('/home/lwogfwhjpj/domains/test.norwit.pl/public_html/vendor/mobiledetect/mobiledetectlib/Mobile_Detect.php')) {
        require_once '/home/lwogfwhjpj/domains/test.norwit.pl/public_html/vendor/mobiledetect/mobiledetectlib/Mobile_Detect.php';
...
if ($_SERVER["REQUEST_METHOD"] === 'GET' && (isset($_COOKIE['jpresta_cache_context']) || jprestaIsSearchEngine())) {
    ...
    $MODULE_PATH = '/home/lwogfwhjpj/domains/test.norwit.pl/public_html/modules/jprestaspeedpack/';
    $CACHE_DIR = '/home/lwogfwhjpj/domains/test.norwit.pl/public_html/var/cache/pagecache/static/';
