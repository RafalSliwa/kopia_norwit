...
<script type="text/html" id="tpl_object_item">
	...
	<td class="object_item_priority">
		<select class="priority-block_select" name="sitemap[<%= type_object + id_object %>][priority]">
	...
	<td class="object_item_changefreq">
		<select class="changefreq-block_select" name="sitemap[<%= type_object + id_object %>][changefreq]">
...
<script type="text/html" id="tpl_object_item_user_link">
	<tr class="object_item">
		<td class="object_item_link">
			...
			<div class="clearfix">
				...
				<div class="translatable-field lang-<%=lang.id_lang%>">
					...
					<div class="translatable-field-lang lang-<%=lang.id_lang%>">
		...
		<td class="object_item_priority">
			<select class="priority-block_select" name="user_links[<%= index %>][priority]">
				<% _.each(priorities, function(priority) { %>
		...
		<td class="object_item_changefreq">
			<select class="changefreq-block_select" name="user_links[<%= index %>][changefreq]">
				<% _.each(changefreqs, function(changefreq) { %>
