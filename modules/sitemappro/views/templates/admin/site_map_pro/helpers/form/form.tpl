                    ...
                    <div id="additional-settings" class="row">
                        ...
                        <div class="settings-block clearfix">
                            ...
                            <div class="col-md-12 margin-top">
                                <div class="row sitemap_row clearfix">
                                    <label class="col-xs-6 col-sm-6 control-label margin-right float-left">{l s='Export sitemaps in robots.txt' mod='sitemappro'}</label>

                                    <div class="col-xs-6 col-sm-6 switch prestashop-switch fixed-width-lg float-left">
                                ...
                                <div class="row sitemap_row clearfix margin-top">
                                    <label class="col-xs-6 col-sm-6 control-label margin-right float-left">{l s='Export category images' mod='sitemappro'}</label>
                                ...
                                <div class="row sitemap_row clearfix margin-top EXPORT_COMBINATION_BLOCK">
                                    <label class="col-xs-6 col-sm-6 control-label margin-right float-left">{l s='Export combinations products' mod='sitemappro'}</label>

                                    <div class="col-xs-6 col-sm-6 switch prestashop-switch fixed-width-lg float-left EXPORT_COMBINATION_BLOCK_RADIO">
                                ...
                                <div class="row sitemap_row clearfix margin-top EXPORT_COMBINATION_DEF_BLOCK">
                                    <label class="col-xs-6 col-sm-6 control-label margin-right float-left">{l s='Export combinations default' mod='sitemappro'}</label>
                                ...
                                <div class="row sitemap_row clearfix margin-top">
                                    <label class="col-xs-6 col-sm-6 control-label margin-right float-left">{l s='Allow image caption attribute' mod='sitemappro'}</label>
                                ...
                                <div class="row sitemap_row clearfix margin-top">
                                    <label class="col-xs-6 col-sm-6 control-label margin-right float-left">{l s='Include id in attribute' mod='sitemappro'}</label>
