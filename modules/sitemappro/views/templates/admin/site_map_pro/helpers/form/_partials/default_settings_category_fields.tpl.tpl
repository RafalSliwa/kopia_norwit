...
<div class="default-category clearfix">
    <div class="row margin-top">
        <label class="col-xs-6 col-sm-6 control-label margin-right">{l s='Define product only by default category' mod='sitemappro'}?
        </label>
        <span class="col-xs-6 col-sm-6 switch prestashop-switch fixed-width-lg">
