...
class UserLink extends ObjectModelSMP
{
    ...
    public static $definition = [
        ...
        'multilang_shop' => true,
        'fields' => [
            'link' => ['type' => self::TYPE_STRING, 'validate' => 'isString', 'lang' => true],
            'priority' => ['type' => self::TYPE_FLOAT, 'shop' => true, 'validate' => 'isUnsignedFloat'],
            'changefreq' => ['type' => self::TYPE_STRING, 'shop' => true, 'validate' => 'isString'],
        ],
    ];
