...
{if $is_use_module}
    <script type="text/javascript" src="{$link_helpers_js|escape:'quotes':'UTF-8'}"></script>
    <script type="text/javascript" src="{$link_select2_js|escape:'quotes':'UTF-8'}"></script>
    <script type="text/javascript" src="{$link_admin_js|escape:'quotes':'UTF-8'}"></script>
    <script type="text/javascript" src="{$link_analysis_js|escape:'quotes':'UTF-8'}"></script>
{/if}
<script type="text/javascript" src="{$link_admin_all_js|escape:'quotes':'UTF-8'}"></script>
