...
class ETS_CFU_Browser
{
    ...
    {
        $br = ETS_CFU_Tools::displayText('', 'br') . "\n";
        $str = ETS_CFU_Tools::displayText('Browser Name:', 'strong') . ' ' . $this->getBrowser() . $br;
        $str .= ETS_CFU_Tools::displayText('Browser Version:', 'strong') . ' ' . $this->getVersion() . $br;
        $str .= ETS_CFU_Tools::displayText('Browser User Agent String:', 'strong') . ' ' . $this->getUserAgent() . $br;
        $str .= ETS_CFU_Tools::displayText('Platform:', 'strong') . ' ' . $this->getPlatform() . $br;
        return $str;
    }
