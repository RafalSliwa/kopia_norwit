...
class ETS_CFU_Translate
{
    public function l($string, $source = null)
    {
        return Translate::getModuleTranslation('ets_cfultimate', $string, $source ?: pathinfo(__FILE__, PATHINFO_FILENAME));
    }

    public static function trans($originalString, $lang, $source = null)
    {
        static $module_name = 'ets_cfultimate';
