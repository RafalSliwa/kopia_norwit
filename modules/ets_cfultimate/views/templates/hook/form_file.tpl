...
<span class="ets_cfu_form-control-wrap {$html_class|escape:'html':'UTF-8'}">
    ...
    {if $type_file || $limit_zie}
        <span class="file_type_des">
            {l s='Limit size:' mod='ets_cfultimate'}&nbsp;{if isset($limit_zie)}{$limit_zie|escape:'html':'UTF-8'}{/if}
            &nbsp;{l s='File types:' mod='ets_cfultimate'}&nbsp;{if isset($type_file)}{$type_file|escape:'html':'UTF-8'}{/if}
        </span>
    {/if}
</span>