...
<script type="text/javascript">
    ...
    var ets_cfu_iso_code = '{if isset($iso_code) && $iso_code}{$iso_code|escape:'html':'UTF-8'}{/if}';
    var ets_cfu_locale = '{if isset($locale) && $locale}{$locale|escape:'html':'UTF-8'}{/if}';
    {if isset($rc_enabled) && $rc_enabled}
        var ets_cfu_recaptcha_v3 = {$rc_v3|intval};
        var ets_cfu_recaptcha_key = "{$rc_key|escape:'html':'UTF-8'}";
    {/if}
    {if isset($hidden_reference) && $hidden_reference}
        var hidden_reference = {$hidden_reference|intval};
    {/if}
</script>
{if isset($rc_enabled) && $rc_enabled}
