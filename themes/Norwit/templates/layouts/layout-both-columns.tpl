...
<head>
  ...
  {literal}
    ...
    <script>
      ...
      })(window, document, 'script', 'dataLayer', 'GTM-K5W9JX6S');
    </script>
      ...
      <div class="{if $page.page_name == 'index'}home-container{else}container{/if}">
        ...
        <div id="columns_inner">
          {block name="left_column"}
            <div id="left-column" class="col-xs-12 nr-left-column" style="width:21.3%">
              <span id="zamknijoknodwa">
                <svg width="16" height="16" viewBox="0 0 24 24">
                  <line x1="4" y1="4" x2="20" y2="20" stroke="black" stroke-width="2"/>
                  <line x1="4" y1="20" x2="20" y2="4" stroke="black" stroke-width="2"/>
                </svg>
              </span>
              {if $page.page_name == 'product'}nr-left-column
          ...
          {block name="right_column"}
            <div id="right-column" class="col-xs-12" style="width:21.3%">
