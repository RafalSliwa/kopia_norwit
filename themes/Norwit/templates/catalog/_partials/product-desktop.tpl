...
<div class="row product-container js-product-container desktop">
    ...
    <div class="nr-wraper-product-container col-xs-12 col-sm-7">
                ...
                <div class="product-short-info">
                    ...
                    {block name='product_questions'}
                        <div class="product-questions">
                            <a href="#">
                                <h4 class="product-questions-title">{l s='Questions & Answers' d='Shop.Theme.Catalog'}</h4>
                            </a>
                        </div>
                    {/block}
                </div>
                            ...
                            <div class="product-brand-img">
                                <a href="{$product_brand_url}">
                                    <img class="product-img img-responsive" src="{$manufacturer_image_url}"
                                        title="{$manufacturer_name}" alt="{$manufacturer_name}" loading="lazy">
                                </a>
                            </div>
                        </div>
                    {/if}
        ...
        <!-- Srodek produktu -->
        <div class="pp-cnter-column col-xs-12  col-sm-6 col-md-4">
            ...
            {block name='product_features'}
                {if $product.grouped_features}
                    <div class="product-features-block">
                        ...
                        <a class="product_details_tabs" href="/">{l s='Full Specifications' d='Shop.Theme.Catalog'}</a>
                ...
                {/if}
            {/block}
            <div class="finansing-media-block">
                <h4 class="finansing-title">{l s='Convenient Financing' d='Shop.Theme.Catalog'}</h4>
                {hook h='displayProductAdditionalInfo' product=$product}
            </div>
        </div>


        <div class="pp-right-column col-xs-12 col-sm-6 col-md-8">
            <div class="product-information">
                <div class="product-actions js-product-actions">
                    {block name='product_buy'}
                        {assign var='is_high_price' value=$product.price_amount >= 1500}
                ...
                {block name='product_offerts'}
                    <div class="product-offerts">
                        {hook h='displayProductAdditionalInfo' product=$product}
                        <button type="button" class="btn btn-primary" onclick="window.location.href='tel:+123456789'">
                ...
                {block name='elementor-element-wraper'}
                    <div class="elementor-elent-wraper row">
            ...
            </div> <!-- Koniec product-information -->

        </div> <!-- Koniec prawej kolumny produktu -->
    </div>
</div>